...
| Preparation Timestamp          | R     | 1..1        | Date and Time    | DD-MM-YYYYhh:mm:ss[+\\|-]hh:mm |             |       |            |            | createdOn        | Дата и час на изготвяне на съобщението по ISO 8601 в локално време с часова зона                                    |
...
| Certificate date            | R     | 1..1        | Date             | DD-MM-YYYY                     |             |       |            |            | certificateDate        | Дата на удостоверение                                                                                               |
| Validity date               | R     | 1..1        | Date             | DD-MM-YYYY                     |             |       |            |            | validityDate           | Дата на валидност на удостоверение                                                                                  |
...
| Contents                       | R     | 1..1        |                  |                                |             |       |            |            | contents         | Съдържание на съобщението                                                                    |
| Operation Id                | R     | 1..1        | UUID             | min=36, max=36                 |             |       |            |            | operationId      | Идентификатор на операция                                                                    |
| Operation started on           | R     | 1..1        | Date and Time    | DD-MM-YYYYhh:mm:ss[+\\|-]hh:mm |             |       |            |            | startedOn        | Дата и час на започване на асинхронната операция по ISO 8601 в локално време с часова зона   |
| Operation completed on         | C     | 1..1        | Date and Time    | DD-MM-YYYYhh:mm:ss[+\\|-]hh:mm |             |       | CDX07      |            | completedOn      | Дата и час на приключване на асинхронната операция по ISO 8601 в локално време с часова зона |
